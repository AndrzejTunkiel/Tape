...
## PCA based 
    ...
    min_required_variance = 0.95 # arbitrary number
...
x1 = GRU(units=128, kernel_initializer =  'glorot_uniform',
...
x2 = Dense(8, kernel_initializer = 'glorot_uniform')(input2)

x2 = Dropout(0.1)(x2)

x2 = Flatten()(x2)

x2 = Dense(4, kernel_initializer = 'glorot_uniform')(x2)
...
history = model.fit(X_train_m,y_train_RNN,validation_data=(X_test_m,y_test_RNN),
                            epochs=2000, verbose=1, batch_size=128,
                            callbacks=[es, mc])
