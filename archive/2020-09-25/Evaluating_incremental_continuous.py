...
try:
    aaes_ticket = np.load('ticket_cont_results.npy')
    aaes_ave = np.load('ave_cont_results.npy')
    r2_ticket = np.load('ticket_cont_results_r2.npy')
    r2_ave = np.load('ave_cont_results_r2.npy')
