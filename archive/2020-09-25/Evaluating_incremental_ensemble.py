...
from training_delta_ensemble import train_delta
...
#%%
np.save('delta ens ref aae.npy', aae_array)    
np.save('delta ens ref ypred.npy', ypred_array)    
np.save('delta ens ref ytrue.npy', ytrue_array)    
