...
# =============================================================================
    ...
    x2 = Dense(data_layer1, kernel_initializer = 'glorot_uniform', input_shape=(memory+predictions,3))(input2)
    x2 = Dropout(drop2)(x2)
    x2 = Flatten()(x2)
    x2 = Dense(data_layer2, kernel_initializer = 'glorot_uniform')(x2)
...
# =============================================================================
    ...
    return valresult, testresult, aae, y_pred, y_test2
