...
axs[0,1].axhline(y=noremean, xmin=0, xmax=1, color='black', linewidth=1,
                 label='no resampling,\naverage')
axs[0,1].axhline(y=nore5, xmin=0, xmax=1, color='black', linewidth=1,
                 label='no resampling,\n5th/95th percentile', linestyle = '--')
axs[0,1].axhline(y=nore95, xmin=0, xmax=1, color='black', linewidth=1, linestyle = '--')
print()
...
axs[1,1].axhline(y=noremean, xmin=0, xmax=1, color='black', linewidth=1)
                 #label='no resampling,\naverage')
axs[1,1].axhline(y=nore95, xmin=0, xmax=1, color='black', linewidth=1, linestyle = '--')
                 #label='no resampling,\n5th/95th percentile',)
