...
axs[0,0].title.set_text('RadiusNeighborsRegressor, weights=distance')
...
axs[0,1].title.set_text('RadiusNeighborsRegressor, weights=uniform')
...
axs[1,0].scatter(extensions, global_results, marker = '.', label='RNR',
               c='black', s=10)

axs[1,0].scatter(extensions, global_p5, marker = '_', label='RNR',
               c='gray', s=10)

axs[1,0].scatter(extensions, global_p95, marker = '_', label='RNR',
               c='gray', s=10)
...
axs[1,0].title.set_text('KNeighborsRegressor, weights=distance')
...
axs[1,1].scatter(extensions, global_results, marker = '.', label='RNR',
               c='black', s=10)

axs[1,1].scatter(extensions, global_p5, marker = '_', label='RNR',
               c='gray', s=10)

axs[1,1].scatter(extensions, global_p95, marker = '_', label='RNR',
               c='gray', s=10)
...
axs[1,1].title.set_text('KNeighborsREgressor, weights=uniform')
