...
#     hAttrCount = 3.0
#     # hDense1 = 1.0
#     # hDense2 = 15.36539690196761
#     # hDense3 = 4.463638810045908
#     # hDrop1 = 0.0
#     # hDrop2 = 0.0
#     # hDrop3 = 0.5
#     # hDense4 = 8
...
def run_me(split,
    ...
    z = Dense(hDense3, activation="relu")(combined) #test reduction!!!!!
...
truths, preds, quals, diffs = optimize_me(382, 0, 0.5, 0.5, 1, 32, 128, 1, 128)
